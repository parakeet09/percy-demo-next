    ...
    <main className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div className="w-32 h-32 bg-gradient-to-br bg-red-500 rounded-xl shadow-lg hover:shadow-xl transform hover:rotate-3 transition-all duration-300 flex items-center justify-center">
